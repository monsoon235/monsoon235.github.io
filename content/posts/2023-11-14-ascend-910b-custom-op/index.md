---
title: Custom PyTorch Operators on Ascend 910B
date: 2023-11-14
slug: 2023-11-14-ascend-910b-custom-op
tags:
  - linux
  - pytorch
  - ascend
...
The hardware environment this article is based on is the Ascend 910B3, and the software environment includes [CANN 7.0-RC1](https://www.hiascend.com/developer/download/community/result), [PyTorch 1.11.0](https://repo.huaweicloud.com/kunpeng/archive/Ascend/PyTorch/), and [Ascend PyTorch Adapter v5.0.rc3-pytorch1.11.0](https://gitee.com/ascend/pytorch/releases/tag/v5.0.rc3-pytorch1.11.0). The situation on other CANN and PyTorch versions may differ slightly.
